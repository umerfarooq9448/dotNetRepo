...
namespace lib_feb10.Controllers
{
    public class BorrowsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            // creating student list to store the data of the student along with the id
            var studentList = (from st in _context.Students
        ...
        // creating book list to store the data of the books along with the id
        var booksList = (from book in _context.Books
            ...
            booksList.Insert(0, new SelectListItem()
            {
                Text = "----Select----",
                Value = string.Empty
            });
